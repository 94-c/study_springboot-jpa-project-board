<<<<<<<< HEAD:src/test/java/com/project/board/controller/ArticleControllerTest.java
package com.project.board.controller;

import com.fastcampus.projectboard.util.PaginationUtil;
import com.project.board.articles.controller.ArticleController;
import com.project.board.config.TestSecurityConfig;
import com.project.board.global.domain.type.FormStatus;
import com.project.board.global.domain.type.SearchType;
import com.project.board.articles.dto.ArticleDto;
import com.project.board.comments.dto.ArticleWithCommentsDto;
import com.project.board.hashtags.dto.HashtagDto;
import com.project.board.users.dto.UserAccountDto;
import com.project.board.articles.dto.request.ArticleRequest;
import com.project.board.articles.dto.response.ArticleResponse;
import com.project.board.articles.service.ArticleService;
import com.project.board.global.util.PaginationUtil;
import com.project.board.global.util.FormDataEncoder;
========
...
>>>>>>>> parent of 36eab90 (#90 - 전체 프로젝트명 변경):src/test/java/com/fastcampus/projectboard/user/controller/ArticleControllerTest.java
...
class ArticleControllerTest {
    ...
    @MockBean private PaginationUtil paginationUtil;
    ...
    void givenNothing_whenRequestingArticlesView_thenReturnsArticlesView() throws Exception {
        ...
        given(paginationUtil.getPaginationBarNumbers(anyInt(), anyInt())).willReturn(List.of(0, 1, 2, 3, 4));
        ...
        then(paginationUtil).should().getPaginationBarNumbers(anyInt(), anyInt());
    }
    ...
    void givenPagingAndSortingParams_whenSearchingArticlesView_thenReturnsArticlesView() throws Exception {
        ...
        given(paginationUtil.getPaginationBarNumbers(pageable.getPageNumber(), Page.empty().getTotalPages())).willReturn(barNumbers);
        ...
        then(paginationUtil).should().getPaginationBarNumbers(pageable.getPageNumber(), Page.empty().getTotalPages());
    }
    ...
    void givenNothing_whenRequestingArticleSearchHashtagView_thenReturnsArticleSearchHashtagView() throws Exception {
        ...
        given(paginationUtil.getPaginationBarNumbers(anyInt(), anyInt())).willReturn(List.of(1, 2, 3, 4, 5));

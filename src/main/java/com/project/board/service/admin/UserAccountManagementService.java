...
import com.project.board.dto.response.admin.AdminUserAccountClientResponse;
...
public class UserAccountManagementService {
    ...
    public List<UserAccountDto> getUserAccounts() {
        URI uri = UriComponentsBuilder.fromHttpUrl(projectProperties.board().url() + "/api/userAccounts")
                ...
                .build()
                .toUri();
        AdminUserAccountClientResponse response = restTemplate.getForObject(uri, AdminUserAccountClientResponse.class);

        return Optional.ofNullable(response).orElseGet(AdminUserAccountClientResponse::empty).userAccounts();
    }

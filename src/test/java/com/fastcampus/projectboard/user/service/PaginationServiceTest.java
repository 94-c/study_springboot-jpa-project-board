...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE, classes = PaginationUtil.class)
class PaginationUtilTest {

    private final PaginationUtil paginationUtil;

    PaginationUtilTest(@Autowired PaginationUtil paginationUtil) {
    ...
    void givenCurrentPageNumberAndTotalPages_whenCalculating_thenReturnsPaginationBarNumbers(int currentPageNumber, int totalPages, List<Integer> expected) {
        ...
        List<Integer> actual = paginationUtil.getPaginationBarNumbers(currentPageNumber, totalPages);
    ...
    void givenNoting_whenCalling_thenReturnsCurrentBarLength() {
        ...
        int barLength = paginationUtil.currentBarLength();

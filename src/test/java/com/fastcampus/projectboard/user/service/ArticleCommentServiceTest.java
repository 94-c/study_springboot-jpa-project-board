<<<<<<<< HEAD:src/test/java/com/project/board/service/ArticleCommentServiceTest.java
...
import com.project.board.comments.repository.ArticleCommentRepository;
import com.project.board.articles.repository.ArticleRepository;
import com.project.board.users.repository.UserAccountRepository;
import com.project.board.comments.service.ArticleCommentService;
========
...
>>>>>>>> parent of 36eab90 (#90 - 전체 프로젝트명 변경):src/test/java/com/fastcampus/projectboard/user/service/ArticleCommentServiceTest.java
...
class ArticleCommentServiceTest {
    ...
    void givenParentCommentIdAndArticleCommentInfo_whenSaving_thenSavesChildComment() {
        ...
        given(userAccountRepository.getReferenceById(child.userAccountDto().id())).willReturn(createUserAccount());
        ...
        then(userAccountRepository).should().getReferenceById(child.userAccountDto().id());
